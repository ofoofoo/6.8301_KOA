...
class MoE_Layer(nn.Module):
    def __init__(self, num_experts=3, hidden_size=32, expert_model_config=[2048, 256, 8]):
...
class MoE_Model(nn.Module):
    def __init__(self, input_dim=32*32*3, hidden_dim=256, output_dim=10):
        ...
        self.moelayer1 = MoE_Layer(num_experts=3, hidden_size=32, expert_model_config=[2048, 256, 32])
        self.moelayer2 = MoE_Layer(num_experts=3, hidden_size=32, expert_model_config=[2048, 256, 32])
    ...
    def forward(self, x):
        ...
        return final_output_real



# model = MoE_Model()
# # Assuming images is your batch of CIFAR-10 images with shape [batch_size, 3, 32, 32]
# # Flatten each image
...
#                                     download=True, transform=transform)
# image, label = dataset_train[0]  # This will fetch the first image and its label from the dataset
# print(image.shape)
# print(dataset_train)
# input = 2
